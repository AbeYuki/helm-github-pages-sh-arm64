...
cd /tmp/helm/bin
wget "https://storage.googleapis.com/kubernetes-helm/helm-v${HELM_VERSION}-linux-arm64.tar.gz"
tar -zxf "helm-v${HELM_VERSION}-linux-arm64.tar.gz"
chmod +x linux-arm64/helm
alias helm=/tmp/helm/bin/linux-arm64/helm
helm version -c
helm init -c
